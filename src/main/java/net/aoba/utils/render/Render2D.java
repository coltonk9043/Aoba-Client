...
// Bottom Left
    ...
    private static void drawRectangles(BufferBuilder bufferBuilder, Matrix4f matrix4f, float x, float y, float width, float height, float radius) {
        bufferBuilder.vertex(matrix4f, x + radius, y, 0).vertex(matrix4f, x + width - radius, y, 0).vertex(matrix4f, x + radius, y + radius, 0);
        bufferBuilder.vertex(matrix4f, x + radius, y + radius, 0).vertex(matrix4f, x + width - radius, y, 0).vertex(matrix4f, x + width - radius, y + radius, 0);

        bufferBuilder.vertex(matrix4f, x + width - radius, y + radius, 0).vertex(matrix4f, x + width, y + radius, 0).vertex(matrix4f, x + width - radius, y + height - radius, 0);
        bufferBuilder.vertex(matrix4f, x + width, y + radius, 0).vertex(matrix4f, x + width, y + height - radius, 0).vertex(matrix4f, x + width - radius, y + height - radius, 0);

        bufferBuilder.vertex(matrix4f, x + width - radius, y + height - radius, 0).vertex(matrix4f, x + width - radius, y + height, 0).vertex(matrix4f, x + radius, y + height - radius, 0);
        bufferBuilder.vertex(matrix4f, x + radius, y + height - radius, 0).vertex(matrix4f, x + radius, y + height, 0).vertex(matrix4f, x + width - radius, y + height, 0);

        bufferBuilder.vertex(matrix4f, x + radius, y + height - radius, 0).vertex(matrix4f, x, y + height - radius, 0).vertex(matrix4f, x, y + radius, 0);
        bufferBuilder.vertex(matrix4f, x, y + radius, 0).vertex(matrix4f, x + radius, y + radius, 0).vertex(matrix4f, x + radius, y + height - radius, 0);

        bufferBuilder.vertex(matrix4f, x + radius, y + radius, 0).vertex(matrix4f, x + width - radius, y + radius, 0).vertex(matrix4f, x + radius, y + height - radius, 0);
        bufferBuilder.vertex(matrix4f, x + radius, y + height - radius, 0).vertex(matrix4f, x + width - radius, y + height - radius, 0).vertex(matrix4f, x + width - radius, y + radius, 0);
    }
}
