...
public abstract class AbstractPathManager {
    ...
    /**
     * Recalculates the path taken by the current pathfinder to reach the target destination.
     * @param pos Target position.
     * @return The list of Path Nodes that represent the path taken to the destination.
     */
    ...
    /**
     * Determines whether a player can pass diagonally from a position to another position.
     * @param playerPos Player's current position.
     * @param pos Position to check.
     * @return whether or not the player can pass diagonally through a block position.
     */
    ...
    /**
     * Function that checks whether a player will fit inside of a block pos from their feet up.
