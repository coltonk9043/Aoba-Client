...
import net.aoba.command.commands.CmdAimbot;
import net.aoba.command.commands.CmdAutoEat;
import net.aoba.command.commands.CmdBreadcrumbs;
import net.aoba.command.commands.CmdChestESP;
import net.aoba.command.commands.CmdClickgui;
import net.aoba.command.commands.CmdDiscord;
import net.aoba.command.commands.CmdEntityESP;
import net.aoba.command.commands.CmdFastBreak;
import net.aoba.command.commands.CmdFly;
import net.aoba.command.commands.CmdFont;
import net.aoba.command.commands.CmdFreecam;
import net.aoba.command.commands.CmdFullbright;
import net.aoba.command.commands.CmdHelp;
import net.aoba.command.commands.CmdHistory;
import net.aoba.command.commands.CmdHud;
import net.aoba.command.commands.CmdItemESP;
import net.aoba.command.commands.CmdNoFall;
import net.aoba.command.commands.CmdNoSlowdown;
import net.aoba.command.commands.CmdNoclip;
import net.aoba.command.commands.CmdNuker;
import net.aoba.command.commands.CmdPOV;
import net.aoba.command.commands.CmdPlayerESP;
import net.aoba.command.commands.CmdReach;
import net.aoba.command.commands.CmdSpam;
import net.aoba.command.commands.CmdSprint;
import net.aoba.command.commands.CmdStep;
import net.aoba.command.commands.CmdTP;
import net.aoba.command.commands.CmdTileBreaker;
import net.aoba.command.commands.CmdTimer;
import net.aoba.command.commands.CmdTracer;
import net.aoba.command.commands.CmdXRay;
...
public class CommandManager {
	...
	public final CmdBreadcrumbs breadcrumbs = new CmdBreadcrumbs();
