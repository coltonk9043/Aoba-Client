...
public class AobaButtonWidget extends PressableWidget {
	...
	protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		RenderManager.getInstance().get2D().drawOutlinedBox(getX(), getY(), width, height, outlineColor, boxColor);
		...
		RenderManager.getInstance().get2D().drawStringWithScale(context, getMessage().getString(), textX, textY,
